...
const EditProductPage = () => {
    ...
    const [price, setPrice] = React.useState(location.state ? location.state.price : 0.01);
     const [quantity, setQuantity] = React.useState(location.state ? location.state.quantity : 1);
    ...
    const handleSubmit = async () => {
        ...
        const response = await updateProduct(jwt.token, location.state ? location.state.id : 1, name,quantity ,categoriesDTO, price,description, );
                                    ...
                                    <TextField
                                        ...
                                        inputProps={{ min: 1 }} />
                                         <TextField
                                                                                value={quantity}
                                                                                sx={{ width: "100%" }}
                                                                                error={isFieldPresentInInputErrors(InputFields.QUANTITY, inputErrors)}
